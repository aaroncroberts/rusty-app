...
impl DatabaseAdapter for SqliteAdapter {
    ...
    async fn bulk_insert(
        ...
        // Use SQLite multi-row INSERT syntax within a transaction for best performance
        // SQLite INSERT syntax: INSERT INTO table (cols) VALUES (?,...), (?,...), ...
        ...
        for row in rows {
            for value in row {
                query_builder = match value {
                    ...
                    QueryValue::Bool(v) => query_builder.bind(*v as i64),
    ...
    async fn bulk_update(
        ...
        // Execute each update in the transaction
    ...
    async fn bulk_delete(
        ...
        // Execute each delete in the transaction
...
mod tests {
    ...
    fn test_bulk_insert_validation_table_name() {
        ...
        rt.block_on(async {
            ...
            // Table name too long (>2000 chars as per SQLite LIMIT_LENGTH default)
            let long_name = "a".repeat(2001);
